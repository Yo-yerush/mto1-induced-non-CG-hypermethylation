...
main_output_directory <- "C:/Users/yonatany/Migal/Rachel Amir Team - General/yonatan/methionine/mto1_paper/linear_plot_new/"
...
annotation_type_names <- c("promoter", "CDS", "intron", "five_prime_UTR", "three_prime_UTR") # "gene",
...
tiff(paste0(path_2_save.2, "lm.stats.plot.", var2_name, ".tif"), width = annotation_type_length*3, height = 7.5, units = "in", res = 600, family = "serif")
do.call(multiplot, c(
    c(all_cntx_points$CG, all_cntx_points$CHG, all_cntx_points$CHH),
    list(
        layout = matrix(1:(annotation_type_length*3), nrow = 3, ncol = annotation_type_length, byrow = TRUE),
        heights = c(1, 0.9, 1),
...
### residuals plot
tiff(paste0(path_2_save.2, "lm.residuals.plot.", var2_name, ".tif"), width = annotation_type_length*3, height = 7.5, units = "in", res = 600, family = "serif")
do.call(multiplot, c(
