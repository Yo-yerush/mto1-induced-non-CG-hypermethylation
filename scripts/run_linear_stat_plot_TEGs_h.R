...
main_output_directory <- "C:/Users/yonatany/Migal/Rachel Amir Team - General/yonatan/methionine/mto1_paper/linear_plot_TEGs/"
...
tiff(paste0(path_2_save.2, "lm.stats.plot.", var2_name, ".tif"), width = annotation_type_length*3, height = 5, units = "in", res = 600, family = "serif")
do.call(multiplot, c(
...
### residuals plot
tiff(paste0(path_2_save.2, "lm.residuals.plot.", var2_name, ".tif"), width = annotation_type_length*3, height = 5, units = "in", res = 600, family = "serif")
do.call(multiplot, c(
